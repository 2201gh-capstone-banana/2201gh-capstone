...
async function seed() {
	...
	for (let i = 0; i < acceptedWord.length; i++) {
		await AcceptedWord.create({
			content: acceptedWord[i]
		})
	}

	const targetWord1 = await TargetWord.create({ content: 'shiny' })
	const targetWord2 = await TargetWord.create({ content: 'march' })
	const [
		acceptedGuess1,
		acceptedGuess2,
		acceptedGuess3,
	...
	await targetWord1.addWordleGame(wordle2)
	await targetWord2.addWordleGame(wordle3)
