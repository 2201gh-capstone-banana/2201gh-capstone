...
async function seed() {
	...
	const targetWord1 = await TargetWord.create({ content: 'opera' })
	const targetWord2 = await TargetWord.create({ content: 'plane' })
	const targetWord3 = await TargetWord.create({ content: 'sharp' })
	const [
		acceptedGuess1,
		acceptedGuess2,
		acceptedGuess3,
	...
	await targetWord2.addWordleGame(wordle2)
	await targetWord3.addWordleGame(wordle3)
	await users[0].addWordleGame(wordle1)
	await users[1].addWordleGame(wordle2)
	await users[0].addWordleGame(wordle3)

	await wordle1.addAcceptedGuess([
		acceptedGuess1,
		acceptedGuess2,
		acceptedGuess3,
		acceptedGuess4,
