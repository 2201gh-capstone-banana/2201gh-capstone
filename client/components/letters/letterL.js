...
// letterL.addDirection(Finger.Thumb, FingerDirection.DiagonalUpLeft, 1.0)
// letterL.addDirection(Finger.Thumb, FingerDirection.DiagonalUpRight, 1.0)
...
for (let finger of [Finger.Middle, Finger.Ring, Finger.Pinky]) {
	...
	// letterL.addDirection(finger, FingerDirection.DiagonalUpLeft, 1.0)
	// letterL.addDirection(finger, FingerDirection.DiagonalUpRight, 1.0)
	// letterL.addDirection(finger, FingerDirection.VerticalDown, 0.25);
}
